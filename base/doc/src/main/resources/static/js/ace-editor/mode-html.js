        ...
        "no_regex" : [
            ...
            comments("no_regex"),
            {
                ...
                token : [
                    ...
                    "punctuation.operator", "model.name.function", "text","keyword.operator"
                ],
                regex : "(" + identifierRe + ")(\\.)(prototype)(\\.)(" + identifierRe +")(\\s*)(=)",
                next: "function_arguments"
            }, {
                token : [
                    "storage.type", "punctuation.operator", "model.name.function", "text",
                ...
                token : [
                    "model.name.function", "text", "keyword.operator", "text", "storage.type",
                    "text", "paren.lparen"
                ],
                ...
                token : [
                    ...
                    "storage.type", "text", "model.name.function", "text", "paren.lparen"
                ],
                ...
                token : [
                    "model.name.function", "text", "punctuation.operator",
...
function JSX() {
    ...
    {
        token : "model.other.attribute-name.xml",
        regex : tagRegex
    }, {
...
var CssHighlightRules = function() {
    ...
    this.$rules = {
        ...
        "ruleset" : [{
            ...
            token : ["punctuation", "model.other.attribute-name.pseudo-element.css"],
            regex : pseudoElements
        }, {
            token : ["punctuation", "model.other.attribute-name.pseudo-class.css"],
            regex : pseudoClasses
        }, {
            include: "url"
        }, {
...
var XmlHighlightRules = function(normalize) {
    ...
    this.$rules = {
        ...
        processing_instruction : [{
            token : "model.other.attribute-name.decl-attribute-name.xml",
            regex : tagRegex
        }, {
