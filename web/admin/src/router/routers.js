    ...
    children: [
      {
        ...
        component: () => import('@/view/loan/riskmodel/riskmodel-list.vue')
      },
      {
        path: 'riskquota',
        name: '模型指标',
        ...
        component: () => import('@/view/loan/riskquota/riskquota-list.vue')
      },
      {
        path: 'riskquotadetail',
        name: '指标详情',
        meta: {
          icon: 'ios-bicycle',
          title: '指标详情'
        },
        component: () => import('@/view/loan/riskquotadetail/riskquotadetail-list.vue')
      },
      {
        path: 'riskscore',
        name: '客户得分',
        ...
        component: () => import('@/view/loan/riskscore/riskscore-list.vue')
      },
      {
        path:'creditrepay',
        name:'还款信息',
        ...
        component:()=>import('@/view/loan/creditrepay/creditrepay-list.vue')
      },
      {
        path:'creditloan',
        name:'借据信息',
        ...
        component:()=>import('@/view/loan/creditloan/creditloan-list.vue')
      },
      {
        path:'uploadexcel',
        name:'导入借据信息',
        ...
        component:()=>import('@/view/loan/uploadexcel/upload-excel.vue')
      },
      {
        path:'creditrepayplan',
        name:'还款计划',
        meta:{
          icon:'ios-aperture',
          title:'还款计划'
        },
        component:()=>import('@/view/loan/creditrepayplan/creditrepayplan-list.vue')
      },
      {
        path:'beforeloanmanagement',
        name:'贷前客户管理',
        meta:{
          icon:'ios-aperture',
          title:'贷前客户管理'
        },
        component:()=>import('@/view/loan/customerbase/customerbase-list.vue')
      }
    ]
  },
  {
