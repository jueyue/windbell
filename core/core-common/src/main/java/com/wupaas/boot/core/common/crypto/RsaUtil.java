 ...
 */
package com.wupaas.boot.core.common.crypto;
...
public class RsaUtil {
    ...
    public static Map<KEY, String> getRSAKeys() throws Exception {
        ...
        map.put(KEY.PUBLICKEY, Base64.encode(rsaPublicKey.getEncoded()));
        map.put(KEY.PRIVATEKEY, Base64.encode(rsaPrivateKey.getEncoded()));
    ...
    public static String rsaDecrypt(final String content, final String privateKey) throws Exception {
        try {
            ...
            byte[]                encryptedData = Base64.decode(content.getBytes(CHAR_SET));
    ...
    public static String rsaEncrypt(final String content, final String publicKey) throws Exception {
        try {
            ...
            byte[] encryptedData = Base64.decode(out.toByteArray());
            out.close();
